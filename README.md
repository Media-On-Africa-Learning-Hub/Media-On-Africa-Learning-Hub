...
\*\*Repository:\*\* \[https://github.com/Media-On-Africa-Learning-Hub/Media-On-Africa-Learning-Hub\](https://www.google.com/search?q=https://github.com/Media-On-Africa-Learning-Hub/Media-On-Africa-Learning-Hub)

\*\*Production Site:\*\* \[https://media-on-africa-learning-hub.github.io\](https://www.google.com/search?q=https://media-on-africa-learning-hub.github.io)

\## Overview

The \*\*DataPulse Learning Hub\*\* is a free, offline-first Progressive Web App (PWA) designed specifically for South African high school learners (Grades 8–12). It delivers CAPS-aligned educational content, self-marking quizzes, career and aptitude assessments, and interactive support forums without requiring an active internet connection once loaded.
...
\* \*\*Service Worker & Caching Guide:\*\* Cache versioning strategies (CACHE\_VERSION), static asset manifest, and network fallback policies.
...
1\. Ensure all new JavaScript files use native ES module imports where appropriate.

2\. Increment \`CACHE\_VERSION\` in \`service-worker.js\` whenever modifying cached static assets.

3\. Test all changes both \*\*Online\*\* and \*\*Offline\*\* (using DevTools Network Throttling) before pushing to \`main\`.