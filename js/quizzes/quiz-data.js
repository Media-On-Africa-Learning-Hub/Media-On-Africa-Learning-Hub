// Quiz question pool, now structured by CAPS term: subject -> grade -> term -> [questions]
//
// This is FALLBACK / DEMO data for offline-first use before a grade+term's
// questions have synced down from Firestore into Dexie. Once the Firebase +
// Gemini pipeline is wired in, loadQuiz() should check Dexie first, and only
// fall back to this static object if nothing is cached yet for that
// subject/grade/term.
//
// term1 below holds your original question sets. term2-term4 are placeholders
